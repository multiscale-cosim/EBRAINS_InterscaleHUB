...
def config_mpi_record (results_path, begin,end, param_nest,param_topology, param_connection,param_background, cosimulation=None):
    """
...
if __name__=='__main__':
    # WARNING nest_io_dev branch mpi backend.
    # assuming it works the same as the refactored mock mpi 
    run_mpi(sys.argv[2]) # results_path argument
